...
function loadGame(dir) {
  ...
  const merged = files.map(function (f) {
    ...
    '\n;\n({ Game: Game, AiCore: AiCore, AiHeuristic: AiHeuristic, AiPlayer: AiPlayer, AiDeckStack: AiDeckStack, AiUiOps: AiUiOps, AI_PROFILES: AI_PROFILES, CARD_MASTER: CARD_MASTER, DECKS: DECKS, Effects: Effects, RuntimeDecks: RuntimeDecks, GameEvents: GameEvents, GAME_EVENT: GAME_EVENT })';
